...
func (f *acctRepo) MaxAccountIndex(context.Context) (int64, error)                    { return -1, nil }
func (f *acctRepo) EnsureAccountIndexIntegrity(context.Context, int64) (int64, error) { return 0, nil }
