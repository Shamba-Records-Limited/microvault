...
func TestGSM7TableMatchesSpec(t *testing.T) {
	...
	for _, c := range []struct {
		...
		{0x00, '@'}, {0x09, 'Ç'}, {0x0A, '\n'}, {0x0D, '\r'}, {0x0F, 'å'},
		{0x10, 'Δ'}, {0x1A, 'Ξ'}, {0x1C, 'Æ'}, {0x1F, 'É'},
		{0x20, ' '}, {0x24, '¤'}, {0x2F, '/'}, {0x30, '0'}, {0x3F, '?'},
		{0x40, '¡'}, {0x41, 'A'}, {0x5A, 'Z'}, {0x5B, 'Ä'}, {0x5C, 'Ö'},
		{0x5D, 'Ñ'}, {0x5E, 'Ü'}, {0x5F, '§'}, {0x60, '¿'}, {0x61, 'a'},
		{0x7A, 'z'}, {0x7B, 'ä'}, {0x7C, 'ö'}, {0x7D, 'ñ'}, {0x7E, 'ü'}, {0x7F, 'à'},
	} {
